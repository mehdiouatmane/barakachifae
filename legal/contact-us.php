...
{	
		    ...
		    $result = mysqli_query(  $con  ,	 "INSERT INTO message (datetime, ip , iplocationcity , name , email , phone , message  ) VALUES ('$datetime' , '$ip'  , '$iplocationcity'  , '$name'  , '$email'  , '$phone'  , '$message'  )"   );            
			   ...
			   <div class="col1a"> <div class="col1b">
					...
					<div style="margin:5% 0% 0% 0%;">Or using the form bellow:</div>
					    <div style="display:grid;">
						  ...
						  <label>Phone Number</label>  <input type="tel" name="phone" placeholder="Phone Number" pattern="[0-9\-]*">
						  <label>Message</label>  <textarea type="text" rows="3"  name="message" placeholder="Message"></textarea>
						  <input style="background-color:black; color:white; font:600 20px 'cairo'; border-radius:5px;" type="submit" value="SEND"  name="sendmessage" >
	                    </div>
				</div></div>
		    </div>
